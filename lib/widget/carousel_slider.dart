...
class CarouselImage extends StatefulWidget {
  //해당위젯은 이미지 쇼,찜하기버튼 등이 있으므로 stateful위젯으로
                    ...
                    children: [
                      likes[_currentPage]
                          ? IconButton(
                              ...
                              onPressed: () {
                                likes[_currentPage] = !likes[
                                    _currentPage]; //likes 커런트 페이지가 true면 check false면 add
                          ...
                          : IconButton(
                              ...
                              onPressed: () {
                                likes[_currentPage] = !likes[
                                _currentPage];                          //likes 커런트 페이지가 false면 add로 바꿈
                                movies[_currentPage].reference.updateData({
                                  'like':likes[_currentPage]
                                });
                              },
